...
solana-keygen new --outfile ~/hb-crown-reserve.json --no-bip39-passphrase
...
spl-token transfer <MINT_ADDRESS> 15000000 \
  $(solana address -k ~/hb-crown-reserve.json) --fund-recipient
...
spl-token balance --owner $(solana address -k ~/hb-crown-reserve.json) <MINT_ADDRESS>
